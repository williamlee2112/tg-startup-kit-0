...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-2", "group-data-[collapsible=icon]:p-2 group-data-[collapsible=icon]:[&>*]:hidden", className)}
      {...props}
    />
  )
}
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "peer-data-[size=lg]/menu-button:top-2.5",
        "group-data-[collapsible=icon]:hidden",
        // Position badge differently if there's a menu action present
        "group-has-data-[sidebar=menu-action]/menu-item:right-7 right-1",
        className
      )}
      {...props}
    />
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      className={cn(
        "border-sidebar-border mx-3.5 flex min-w-0 translate-x-px flex-col gap-0.5 border-l px-2.5 py-0",
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
